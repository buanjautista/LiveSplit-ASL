...
startup
{
  ...
  vars.bosses = new Dictionary<string, string> { { "Red Tiger Elite: Baichang", "baichang_kill" }, { "Jiaoduan", "jiaoduan_kill" },{ "Xingtian", "xingtian_kill" }, { "Kanghui", "kanghui_kill" }, { "Celestial Enforcer: Huanxian", "huanxian_kill" }, { "The Great Miner: Tianshou", "tianshou_kill" }, { "Eigong", "eigong_kill" } };
